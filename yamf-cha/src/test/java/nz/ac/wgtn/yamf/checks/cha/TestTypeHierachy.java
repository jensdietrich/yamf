...
public class TestTypeHierachy {
    ...
    public void setup() throws Exception {
        File testProjectRoot = new File(TestTypeHierachy.class.getResource("/test-typehierarchy").getFile());
        ...
        typeHierarchy = CHAActions.constructTypeHierachy(classFiles,dependencies);
