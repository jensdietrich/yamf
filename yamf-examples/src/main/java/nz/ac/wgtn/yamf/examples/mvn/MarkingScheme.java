...
public class MarkingScheme {
    ...
    public void testCompilation () throws Exception {
        MVNActions.compile(submission, FailedExpectationHandler.AssumeTrue);
    }

    @Test
    @Marking(name="Q5 -- project must be testable", marks = 1)
    public void testTest () throws Exception {
        MVNActions.test(submission, FailedExpectationHandler.AssumeTrue);
    }
    ...
    public void testDependencies () throws Exception {
        MVNActions.test(submission,true, FailedExpectationHandler.AssumeTrue);
        File pom = new File(submission,"pom.xml");
