...
public class MarkingScheme {
    ...
    public void runSimpleAcceptanceTests () throws Exception {
        TestResults results = MVNActions.acceptanceTestMvnProject(junitRunner,"acceptancetests.TestCalculatorSimple", submission,acceptanceTestProjectFolder,true, JUnitVersion.JUNIT5, OnFailure.MARK_MANUALLY);
    ...
    public void runAdvancedAcceptanceTests () throws Exception {
        TestResults results = MVNActions.acceptanceTestMvnProject(junitRunner,"acceptancetests.TestCalculatorOverflow", submission,acceptanceTestProjectFolder,true,JUnitVersion.JUNIT5, OnFailure.MARK_MANUALLY);
